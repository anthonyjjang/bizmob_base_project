<template>
    ...
    <v-row>
        <v-col cols="12" style="min-width: 1400px;">
            <Panel :title="'사용자'" class="mt-6">
                <v-row>
                    <v-col cols="2" md="2">
                        <v-text-field v-model="department" variant="outlined" color="primary" hide-details="true" placeholder="부서명"></v-text-field>
                    </v-col>
                    <v-col cols="2" md="2">
                        <v-text-field v-model="userId" variant="outlined" color="primary" hide-details="true" placeholder="사용자ID"></v-text-field>
                    </v-col>
                    <v-col cols="2" md="2">
                        <v-text-field v-model="userNm" variant="outlined" color="primary" hide-details="true" placeholder="이름"></v-text-field>
                    </v-col>
                    <v-col cols="2" md="2">
                        <MvpSelect
                            v-model="selectedYn"
